...
| Tools → *Import history* | Imports the messenger's journal for the last 1 / 6 / 24 hours into the messages table — what happened before receiving was switched on. Messages already in the table are skipped. | `lastIncomingMessages`, `lastOutgoingMessages` |
